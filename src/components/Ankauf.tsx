...
export default function Ankauf() {
  ...
  return (
    <section id="ankauf" className="section-padding bg-gradient-to-b from-black via-gray-950 to-black relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-#6cb036/10 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-#6cb036/5 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mt-4 mb-6">
              Verkaufen Sie Ihr
              <span className="text-#6cb036"> Fahrzeug</span>
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-#6cb036/20 flex items-center justify-center">
                    <CheckCircle className="w-4 h-4 text-#6cb036" />
                  </div>
          ...
          >
            <div className="glass rounded-3xl p-8 md:p-10">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-#6cb036 to-#5a9a2d flex items-center justify-center">
